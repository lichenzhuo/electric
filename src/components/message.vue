  ...
  <div class="singalwarn">
    ...
    <div class="table">
      ...
      >
        ...
        <el-table-column align="center" prop="one" label="地点"></el-table-column>
        ...
        <el-table-column align="center" prop="5" label="工作人员">
          <template scope="scope">
            <el-tag>{{scope.row.five}}</el-tag>
          </template>
        </el-table-column>
        <el-table-column align="center" prop="6" label="联系电话"></el-table-column>
        <el-table-column align="center" prop="7" label="角色"></el-table-column>
