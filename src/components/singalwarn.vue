  ...
  <div class="singalwarn">
    ...
    <div class="table">
      <el-table
        ...
        style="width: 100%"
      >
        <el-table-column prop="0" label="预警时间" width="160"></el-table-column>
        <el-table-column prop="one" label="母线电压">
          <template scope="scope">
            <span v-if="scope.row.one=='22v'">{{scope.row.one}}</span>
            <span v-else style="color: red">{{scope.row.one}}</span>
          </template>
        </el-table-column>
        <el-table-column prop="2" label="正极电压"></el-table-column>
        <el-table-column prop="3" label="负极电压"></el-table-column>
        <el-table-column prop="4" label="正负压差"></el-table-column>
        <el-table-column prop="5" label="交流电压"></el-table-column>
        <el-table-column prop="6" label="纹波电压"></el-table-column>
        <el-table-column prop="7" label="正极绝缘"></el-table-column>
        <el-table-column prop="8" label="负极绝缘"></el-table-column>
        <el-table-column prop="9" label="母联绝缘"></el-table-column>
      </el-table>
      <div class="page">
        <el-pagination
